                ...
                <form action="?act=cn-donhang" method="post">
                    ...
                    <div class="tinhtrang">
                        ...
                        <select name="bill_status">
                            ...
                            <option value="3" <?php if ($old_dh['bill_status'] == "3") : ?>selected <?php endif; ?>>Đang kiểm hàng</option>
                            <option value="4" <?php if ($old_dh['bill_status'] == "4") : ?>selected <?php endif; ?>>Đang giao</option>
